...
const GitHubRepos=(props)=>{
    return(
<Fragment>
    <div className={`${styles.content} flex justify-center max-md:mb-2 flex-col my-[2rem] bg-gray-700 shadow-md w-[36%] max-md:w-[92%] pb-[2rem] rounded-lg`}>
        <header  className='bg-white rounded-lg flex justify-between px-4 py-4'>
            <div className='flex flex-col gap-3'>
        <h2 className='font-bold text-lg'>Name of Repository</h2>
        <h4>{props.name}</h4>
        </div>
        <MygitSvg/>
        </header>
