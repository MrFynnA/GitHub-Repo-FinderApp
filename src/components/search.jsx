...
<Fragment>
 ...
 <input type='text' className='max-md:w-[48%] max-md:!text-sm max-md:!pl-4 max-md:!py-4 max-md:placeholder:!text-[1rem]' placeholder='Enter Username' value={userName} onChange={onUserChange}/>
